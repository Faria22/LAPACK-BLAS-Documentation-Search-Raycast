...
```fortran
ZLAQP3RK(M, N, NRHS, IOFFSET, NB, ABSTOL,
...
KP1 is INTEGER The index of the column with the maximum 2-norm in the whole original matrix A_orig determined in the main routine ZGEQP3RK. 1 <= KP1 <= N_orig.
