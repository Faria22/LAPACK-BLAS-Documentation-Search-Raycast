...
```fortran
CPORFSX(UPLO, EQUED, N, NRHS, A, LDA, AF, LDAF, S, B,
...
X is COMPLEX array, dimension (LDX,NRHS) On entry, the solution matrix X, as computed by SGETRS. On exit, the improved solution matrix X.
