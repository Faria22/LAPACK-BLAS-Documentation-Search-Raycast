...
```fortran
ZPORFS(UPLO, N, NRHS, A, LDA, AF, LDAF, B, LDB, X,
...
X is COMPLEX*16 array, dimension (LDX,NRHS) On entry, the solution matrix X, as computed by ZPOTRS. On exit, the improved solution matrix X.
