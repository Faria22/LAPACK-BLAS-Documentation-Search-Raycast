...
```fortran
SORBDB2(M, P, Q, X11, LDX11, X21, LDX21, THETA, PHI,
...
TAUP1 is REAL array, dimension (P-1) The scalar factors of the elementary reflectors that define P1.

### TAUP2 (out)

TAUP2 is REAL array, dimension (Q) The scalar factors of the elementary reflectors that define P2.
